...
const { sectionDoctors } = useStore.getState();
      ...
      <div className='flex flex-wrap  gap-2'>
        {sectionDoctors?.map((item) => (
          <Link
            ...
            <div
              key={item.id}
              className=' flex gap-4 p-4 items-center rounded-[163px] shadow-md border-[1px] border-gray-400 bg-slate-200 hover:bg-sky-200 dark:border-gray-700 dark:bg-inputDark hover:border-gray-100 dark:hover:opacity-90'>
