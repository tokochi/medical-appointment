     ...
     <div id='personal-info' className='card rounded-md '>
       ...
       <form
         ...
         <div id='avatar' className='flex gap-2 justify-center items-center min-w-[250px]'>
           ...
           <div className='pt-4'>
             <div className=' '>
               {adminInfo?.avatar?.length > 1 && (
                 <button
                   name={adminInfo?.avatar?.[0]}
                   onClick={(e) => removeSelectAvatar(e, "adminInfo")}>
                   <svg
         ...
         <div id='commune' className=''>
           <SelectInput
             ...
             options={commune.filter(
               (region) => region?.daira === adminInfo?.address?.daira?.value
             )}
             option_value='value'
             option_text='text'
             placeholder='البلدية'
