...
function HeadTitle() {
  ...
  return (
    <div
      id='title'
      className='overflow-hidden shadow-md shadow-cyan-400/30 dark:shadow-transparent s flex justify-between m-4  md:mx-10  bg-primary rounded-2xl'>
      <h1 className='p-4 text-clamp-xl font-bold text-white '>{pathname}</h1>
      <Image className='min-w-[50px]' src='/images/pulse-2.png' width={150} height={150} alt='input' />
    </div>
  );
}
