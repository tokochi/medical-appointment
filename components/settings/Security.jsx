...
export default function Security() {
  ...
  return (
    <div className={`grow overflow-y-auto h-[calc(100vh_-_190px)] "bg-white" "text-slate-800"`}>
        ...
        <div className="flex flex-col px-6 py-3 border-t border-slate-200">
          <div className="flex self-end">
            <button
              ...
              // type="submit"
              className={`btn ${theme.nav} "text-slate-500" border-slate-200 hover:border-slate-300 text-slate-600`}>
              Reset
            </button>
            <button
              type="submit"
