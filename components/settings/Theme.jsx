...
export default function Theme() {
  ...
  return (
    <div className={`grow overflow-y-auto shadow-lg h-[calc(100vh_-_190px)] w-full rounded-sm  "bg-white" transition-colors  duration-300 relative  "text-slate-800"`}>
      {/* Panel body */}
      <div className="p-6 space-y-6 ">
        <h2 className={`text-2xl "text-slate-800" font-bold mb-5`}>Apparence</h2>
          ...
          <ul>
            <li className="flex justify-between items-center py-3 border-b border-slate-200">
              ...
              <div className="flex  items-center gap-6">
                ...
                <label id="name" className={` "text-slate-500" mt-6`}>
                  Claire
                </label>
                <RadioButtonComponent
                  // label="Sombre"
